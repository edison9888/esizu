...
#define DEFAULTS_LAST_PAYMODE_ID        @"LAST_PAYMODE_ID"
...
{
    return (NSString*)[self getDefaultsObjectForKey:DEFAULTS_LAST_PAYMODE_ID];
}

- (void) setLastPaymodeID:(NSString*)aPaymodeID
{
    [self setLastDefaultsObject:aPaymodeID forKey:DEFAULTS_LAST_PAYMODE_ID];
    return;
}

- (NSObject*) getDefaultsObjectForKey:(NSString*)aKey
{
    NSUserDefaults* sUserDefaults = [NSUserDefaults standardUserDefaults];
    NSString* sLastAddressID =[sUserDefaults objectForKey:aKey];
    
    return sLastAddressID;

}

- (void) setLastDefaultsObject:(NSObject*)aObject forKey:(NSString*)aKey
{
    NSUserDefaults* sUserDefaults = [NSUserDefaults standardUserDefaults];
    [sUserDefaults setValue:aObject forKey:aKey];
}
