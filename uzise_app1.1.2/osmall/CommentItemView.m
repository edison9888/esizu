...
- (void) configSubviews;
{
    ...
    self.mCommentorLabel.textColor = [UIColor blackColor];
...
- (void) fillValueByCommentor:(NSString*)aCommentor Date:(NSString*)aDateStr Content:(NSString*)aContent
{
    self.mCommentorLabel.text = aCommentor;
    self.mDateLabel.text = aDateStr;
