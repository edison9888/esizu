...
#define URL_PRODUCT_INFO                ([HOST_URL_STR stringByAppendingString: @"/app_image/iphone/html/details.html"])
#define URL_PRODUCT_COMMENTS            ([HOST_URL_STR stringByAppendingString: @"/api/product/commentList.jspx"])
