...
-(NSArray*)buildTabbarChildren
{
    ...
    [self.homeNavigationController.tabBarItem setTitle:NSLocalizedString(@"Home", @"homeTabBar")];
    ...
    [sCategoryController setTitle:NSLocalizedString(@"Category", @"categoryTabBar")];
    [self.categoryNavigationController.tabBarItem setImage:[UIImage imageNamed:@"259-list"]];
    [self.cartNavigationController.tabBarItem setTitle:NSLocalizedString(@"Category", @"categoryTabBar")];
