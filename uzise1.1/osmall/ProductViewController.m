        ...
        switch (indexPath.row) {
          ...
          //      [introduction_lable setLineBreakMode:UILineBreakModeWordWrap];
            ...
            case 2:{
                ...
                static NSString *productIntroductionCellIdentifier = @"productIntroduction";
                ...
                cell.textLabel.text = NSLocalizedString(@"ProductIntroduction", @"ProductIntroduction");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        case 2:{
            ...
            [productDetailViewController setUrl:[NSString stringWithFormat:@"%@?pid=%d", URL_PRODUCT_INFO, self.product_id]];
